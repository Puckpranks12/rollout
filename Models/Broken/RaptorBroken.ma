...
//Name: RaptorBroken.ma
//Last modified: Thu, Jul 26, 2018 09:22:19 AM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 20.696516459390303 18.660117749865851 85.307265705653762 ;
	setAttr ".r" -type "double3" 348.26164725820479 1458.5999999994851 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8E01E417-4B9F-18C4-EA24-D1B40EEFA737";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 88.972285775407613;
...
createNode transform -n "Raptor";
	...
	setAttr ".t" -type "double3" 0 -4.5720695071111237 0 ;
	setAttr ".r" -type "double3" 44.353318412833659 0 0 ;
createNode transform -n "Head" -p "Raptor";
	rename -uid "E9C59EC8-4451-7018-B87B-63A5495FC951";
	setAttr ".t" -type "double3" 0 17.608965135372426 9.4602016001272524 ;
	setAttr ".r" -type "double3" -57.396613433649954 0 0 ;
...
createNode mesh -n "HeadShape" -p "Head";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.3815644383430481 0.28707683831453323 ;
	...
	setAttr -s 19 ".pt";
	setAttr ".pt[1]" -type "float3" 0 0.037574984 -0.16219588 ;
	setAttr ".pt[5]" -type "float3" 0 0.062241293 -0.26867023 ;
	setAttr ".pt[9]" -type "float3" 0 -0.15706187 -0.036385614 ;
	setAttr ".pt[10]" -type "float3" 0 -0.15706187 -0.036385614 ;
	setAttr ".pt[11]" -type "float3" -0.10975357 -0.080579147 -0.018667307 ;
	setAttr ".pt[17]" -type "float3" 0 -0.080104396 -0.018557323 ;
	setAttr ".pt[21]" -type "float3" 0 -0.029751802 0.12842639 ;
	setAttr ".pt[22]" -type "float3" 0 -0.029751802 0.12842639 ;
	setAttr ".pt[24]" -type "float3" 0 -0.06519822 0.28143409 ;
	setAttr ".pt[25]" -type "float3" 0 -0.15865251 0.68483824 ;
	setAttr ".pt[26]" -type "float3" 0 -0.15865251 0.68483824 ;
	setAttr ".pt[27]" -type "float3" 0 -0.062551081 0.27000746 ;
	setAttr ".pt[29]" -type "float3" 0 -0.040138911 0.17326328 ;
	setAttr ".pt[30]" -type "float3" 0 -0.040138911 0.17326328 ;
	setAttr ".pt[49]" -type "float3" -0.21184024 6.3143935e-016 -5.2735594e-016 ;
	setAttr ".pt[59]" -type "float3" 0 -0.08641351 0.37301183 ;
	setAttr ".pt[60]" -type "float3" 0 -0.032648183 0.14092886 ;
	setAttr ".pt[71]" -type "float3" 0 -0.088858739 0.38356677 ;
	setAttr ".pt[72]" -type "float3" 0 -0.027653351 0.11936821 ;
createNode transform -n "Spine_2" -p "Raptor";
	...
	setAttr ".r" -type "double3" -14.014220333939035 0 0 ;
...
createNode mesh -n "Spine_2Shape" -p "Spine_2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.42146812379360199 0.13163524866104126 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[13]" -type "float3" 0 -0.10981144 -0.23020063 ;
	setAttr ".pt[14]" -type "float3" 0 -0.10981144 -0.23020063 ;
	setAttr ".pt[65]" -type "float3" 0 -0.18560742 -0.07416752 ;
	setAttr ".pt[66]" -type "float3" 0 -0.18560742 -0.07416752 ;
	setAttr ".pt[69]" -type "float3" 0 -0.11981171 -0.055358797 ;
	setAttr ".pt[70]" -type "float3" 0 -0.11981171 -0.055358797 ;
createNode transform -n "Hip" -p "Raptor";
	rename -uid "C9069373-407A-18A3-2DEE-AD8DF74A08BE";
	setAttr ".t" -type "double3" 0 5.2806580056166714 -4.9971151320760807 ;
	setAttr ".r" -type "double3" 44.497443123593094 0 0 ;
...
createNode mesh -n "HipShape" -p "Hip";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.33297786116600037 0.30227439105510712 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt";
	setAttr ".pt[35]" -type "float3" -0.30869538 -2.4980018e-016 -2.220446e-016 ;
	setAttr ".pt[48]" -type "float3" -0.30869538 -2.4980018e-016 -1.9428903e-016 ;
createNode transform -n "L_hip_1" -p "Hip";
	rename -uid "01D8A1BD-43D8-D73B-C092-A0ADBE9B95AD";
	setAttr ".t" -type "double3" 0.4454054458235121 -0.1317902698475196 0.13102426645413756 ;
	setAttr ".r" -type "double3" 0 0 63.505801087975037 ;
	setAttr ".s" -type "double3" 0.20736056128684296 0.33730258163470545 0.11155739542405591 ;
	setAttr ".sh" -type "double3" 0.1277081915866308 0 0 ;
...
createNode transform -n "L_leg_1" -p "L_hip_1";
	rename -uid "66CBC5EB-4999-711F-49FF-08866032C561";
	setAttr ".t" -type "double3" 0.83129167848759034 -1.2719558062484548 -1.4190975462390372 ;
	setAttr ".r" -type "double3" 156.2244364903714 0 135.5264423572502 ;
	setAttr ".s" -type "double3" 2.5159225125393898 5.5218027696496907 4.9137500319341196 ;
	setAttr ".sh" -type "double3" -0.29389789938482241 -0.36515275556211407 -0.21083108021387176 ;
createNode mesh -n "L_leg_Shape1" -p "L_leg_1";
	rename -uid "FD2900D9-454D-1F77-63BC-57B68F4F2990";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.88847166299819946 0.1674155592918396 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt";
	setAttr ".pt[1]" -type "float3" -0.11091225 0.036157325 -0.19305016 ;
	setAttr ".pt[45]" -type "float3" -0.11091225 0.036157325 -0.19305016 ;
createNode mesh -n "polySurfaceShape3" -p "L_leg_1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "L_knee" -p "L_leg_1";
	rename -uid "F3AD1F50-459E-15BD-2B53-F4A5A8D9A82D";
	setAttr ".t" -type "double3" 0.0073983708871878662 -0.90200355360630757 -0.86721362986242689 ;
	setAttr ".r" -type "double3" -180 -42.36221519447092 89.999999999999972 ;
	setAttr ".s" -type "double3" 0.26035750083302711 0.27850552720041005 0.27667286480890108 ;
	setAttr ".sh" -type "double3" 0 -0.0084461110058783803 0 ;
createNode mesh -n "L_kneeShape" -p "L_knee";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "L_leg_2" -p "L_knee";
	rename -uid "CA9ECAFA-4A6B-4F85-C91D-8DB77D868C7E";
	setAttr ".t" -type "double3" -2.4929172539429558 -0.026564538813854455 -2.8210058255898205 ;
	setAttr ".r" -type "double3" 122.48881630932152 -3.1805546814635168e-015 90.000000000000057 ;
	setAttr ".s" -type "double3" 3.5905930128288239 5.5564727146477138 3.1509242222128986 ;
...
createNode mesh -n "polySurfaceShape2" -p "L_leg_2";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_hip_1" -p "Hip";
	rename -uid "5BA982AA-4473-FB33-F2EB-F4A7D780CE12";
	setAttr ".t" -type "double3" -0.48602098033299407 -0.12259619131849597 0.095270081441701571 ;
	setAttr ".r" -type "double3" 0 0 -63.505801087975037 ;
	setAttr ".s" -type "double3" 0.20736056128684296 0.33705380624972087 0.11155739542405591 ;
	setAttr ".sh" -type "double3" -0.12770819158663083 0 0 ;
...
createNode mesh -n "polySurfaceShape13" -p "R_hip_1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_leg_1" -p "R_hip_1";
	rename -uid "2860EE27-4875-86F8-82BC-8EA5848545ED";
	setAttr ".t" -type "double3" 4.0820624636587644 3.5058749712722332 -1.0985971896600233 ;
	setAttr ".r" -type "double3" 139.37452085730479 -1.5902773407317588e-015 -135.50530891917185 ;
	setAttr ".s" -type "double3" 2.5168341087256336 4.8389263961516447 5.6092918039574018 ;
	setAttr ".sh" -type "double3" 0.51584314666408349 0.028903050134037944 -0.029310864817746668 ;
...
createNode mesh -n "polySurfaceShape5" -p "R_leg_1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_knee" -p "R_leg_1";
	rename -uid "26FEEC45-42BC-1080-AA0B-139E97C83D2A";
	setAttr ".t" -type "double3" 2.6632545102242267 -0.90200355360630713 -0.867213629862427 ;
	setAttr ".r" -type "double3" -130.90192232955408 -54.528685904847848 90.000000000000242 ;
	setAttr ".s" -type "double3" 0.26035750083302711 0.27850552720041005 0.27667286480890108 ;
	setAttr ".sh" -type "double3" 0 -0.0084461110058783803 0 ;
createNode mesh -n "R_kneeShape" -p "R_knee";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode mesh -n "polySurfaceShape14" -p "R_knee";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_leg_2" -p "R_knee";
	rename -uid "9355E967-48CC-D94C-33A2-35847C5E701E";
	setAttr ".t" -type "double3" -2.4929172539429501 -9.5626630357959606 -2.8210058255898161 ;
	setAttr ".r" -type "double3" 122.48881630932152 0 90.000000000000028 ;
	setAttr ".s" -type "double3" 3.590593012828823 5.5564727146477111 3.1509242222128973 ;
createNode mesh -n "R_leg_Shape2" -p "R_leg_2";
	rename -uid "DAEC6DB8-4CD9-3331-49A2-5295DA72EA36";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.81090378761291504 0.50130075216293335 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt[50:51]" -type "float3"  0.17001943 -0.10830034 0.11922063 
		0.17001943 -0.10830034 0.11922063;
...
createNode transform -n "L_arm_1" -p "Raptor";
	...
	setAttr ".r" -type "double3" -68.873942140479755 184.9697908067933 52.631399749167947 ;
...
createNode mesh -n "L_arm_Shape1" -p "L_arm_1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.77704256772994995 0.34070734679698944 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt";
	setAttr ".pt[32]" -type "float3" 0.32677299 -0.18379897 0.10190272 ;
	setAttr ".pt[52]" -type "float3" 0.32677299 -0.18379897 0.10190272 ;
...
createNode transform -n "L_elbow" -p "Raptor";
	...
	setAttr ".t" -type "double3" 12.877099375067324 11.022856410720546 -7.6543847478405116 ;
...
createNode transform -n "L_arm_2" -p "Raptor";
	...
	setAttr ".t" -type "double3" 16.898270151185283 10.880870256168176 -4.0575649034415155 ;
	setAttr ".r" -type "double3" 25.209928033563539 46.146964281974469 32.01579155290861 ;
...
createNode transform -n "L_gun_1" -p "Raptor";
	...
	setAttr ".t" -type "double3" 19.180180626147806 9.757807908069914 -0.50147623121333407 ;
	setAttr ".r" -type "double3" 109.68692658181834 49.669993264294106 14.286189349383685 ;
...
createNode mesh -n "L_gun_Shape1" -p "L_gun_1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.51539087295532227 0.68784680962562561 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "R_arm_1" -p "Raptor";
	...
	setAttr ".t" -type "double3" 3.8192777983317558 10.970444864580504 2.9703399059835291 ;
	setAttr ".r" -type "double3" -42.546142470292807 167.51602466943399 6.1447061506199834 ;
	setAttr ".s" -type "double3" 4.8817076626963916 7.7180615428539925 5.6163030613695355 ;
createNode mesh -n "R_arm_Shape1" -p "R_arm_1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.017104566097259521 0.17212027311325073 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[4]" -type "float3" -0.012215242 -0.0051633678 -0.13840404 ;
	setAttr ".pt[8]" -type "float3" -0.012215242 -0.0051633678 -0.13840404 ;
	setAttr ".pt[35]" -type "float3" 0.021208633 0.0089648655 0.24030316 ;
	setAttr ".pt[45]" -type "float3" 0.2843076 0.041529715 -0.021883529 ;
	setAttr ".pt[46]" -type "float3" 0.2843076 0.041529715 -0.021883529 ;
	setAttr ".pt[48]" -type "float3" 0.021208633 0.0089648655 0.24030316 ;
...
createNode mesh -n "polySurfaceShape6" -p "R_arm_1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_elbow" -p "R_arm_1";
	rename -uid "EA1FE5DD-4395-25E8-3F17-F795DFEB83DF";
	setAttr ".t" -type "double3" 0.48221994459111356 -2.2683975341647207 -0.84707170939939591 ;
	setAttr ".r" -type "double3" -153.72324761949474 -73.953466048094754 89.998976942808952 ;
	setAttr ".s" -type "double3" 0.26781726023484681 0.20475731140138928 0.20820683073107077 ;
	setAttr ".sh" -type "double3" -0.0056286452151547662 -0.22075826315475061 -0.034110045659235921 ;
...
createNode mesh -n "polySurfaceShape7" -p "R_elbow";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_arm_2" -p "R_elbow";
	rename -uid "DD6B8B1D-476A-C610-3AB0-349363F59C91";
	setAttr ".t" -type "double3" -1.4873485300222904 0.01750485855308348 3.431250148120828 ;
	setAttr ".r" -type "double3" 18.316909958392024 1.590277340731758e-015 -89.999999999999972 ;
	setAttr ".s" -type "double3" 4.4112773458007206 2.838001469529873 6.6279745746037424 ;
createNode mesh -n "R_arm_Shape2" -p "R_arm_2";
	rename -uid "4122BA4E-418D-7AD0-EFFD-1F9625EB207D";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.67454156279563904 0.38626077771186829 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[16]" -type "float3" -0.16763015 -0.043565392 -0.029740999 ;
	setAttr ".pt[17]" -type "float3" -0.16279359 -0.042308416 -0.028882898 ;
	setAttr ".pt[18]" -type "float3" -0.16279359 -0.042308416 -0.028882898 ;
	setAttr ".pt[19]" -type "float3" -0.10003433 -0.025997918 -0.017748129 ;
	setAttr ".pt[51]" -type "float3" -0.10003433 -0.025997918 -0.017748129 ;
	setAttr ".pt[55]" -type "float3" -0.16763015 -0.043565392 -0.029740999 ;
createNode mesh -n "polySurfaceShape8" -p "R_arm_2";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_gun_1" -p "R_arm_2";
	rename -uid "C0B5017A-44A2-D6FB-815D-D0B7CCDF7921";
	setAttr ".t" -type "double3" 0.43502296493021841 -0.24048943225804925 0.3551105061700518 ;
	setAttr ".r" -type "double3" 84.225135026910976 2.3096003297696983 -34.63524660722225 ;
	setAttr ".s" -type "double3" 0.22587620385598906 0.46721992570769227 0.22575413409233147 ;
	setAttr ".sh" -type "double3" 0.17716582240416442 0.0033363145622468202 -0.082301507837737806 ;
...
createNode mesh -n "polySurfaceShape9" -p "R_gun_1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "R_gun_2" -p "R_arm_2";
	rename -uid "8A06D742-436D-9A4C-242F-D9A7EEFD9DC3";
	setAttr ".t" -type "double3" 0.46962125039539115 -0.24616735468597034 0.50947110094285142 ;
	setAttr ".r" -type "double3" 84.224744620560372 2.3094923192089949 -34.63515830788721 ;
	setAttr ".s" -type "double3" 0.26115172223566102 0.47921198109497004 0.26101035444538984 ;
	setAttr ".sh" -type "double3" 0.17715755189127741 0.0033363873957444477 -0.082307101144055969 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "240FAE45-4381-4878-4BC4-5E89A948CD3A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "BD699986-420A-92D9-A6D3-84A3C50AD2C1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C4FCF537-47C7-6C1C-417C-FD829BD52F0B";
createNode displayLayerManager -n "layerManager";
	rename -uid "F7E41B43-495D-6C2F-46D2-F69D03F2AA01";
createNode displayLayer -n "defaultLayer";
	rename -uid "5882F557-46CA-0D87-14FA-C0B12824719E";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C6232C67-4FFF-0341-E7A9-4ABD906FE411";
...
createNode polySoftEdge -n "polySoftEdge7";
	rename -uid "195E446B-4CB4-B0F6-7DE5-91ABAAD22DD6";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[*]";
	setAttr ".ix" -type "matrix" 0.96276256083092848 0.043314381514405267 -0.26685598328742277 0
		 1.2888407361037968 -1.0236402973470538 4.4837265647252726 0 -0.016530618517682089 -0.97580309837771284 -0.21802534680141794 0
...
createNode polyTweak -n "polyTweak20";
	rename -uid "E74A6C7E-4AD9-C0B4-AD03-55AC2CB974D3";
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[8]" -type "float3" 0.24123071 -0.18419589 -0.31162271 ;
	setAttr ".tk[9]" -type "float3" 0.13586196 -0.10006503 0.11100133 ;
	setAttr ".tk[10]" -type "float3" 0.13586196 -0.10006503 0.11100133 ;
	setAttr ".tk[13]" -type "float3" 0.096449122 -0.071036696 0.078800388 ;
	setAttr ".tk[14]" -type "float3" 0.096449122 -0.071036696 0.078800388 ;
	setAttr ".tk[15]" -type "float3" 0.24123071 -0.18419589 -0.31162271 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyTweakUV14.out" "R_kneeShape.i";
connectAttr "polyTweakUV14.uvtk[0]" "R_kneeShape.uvst[0].uvtw";
...
connectAttr "polySoftEdge7.out" "L_gun_Shape1.i";
...
connectAttr "|Raptor|Hip|L_hip_1|L_leg_1|L_knee|L_leg_2|polySurfaceShape2.o" "polyExtrudeFace4.ip"
		;
connectAttr "L_leg_Shape2.wm" "polyExtrudeFace4.mp";
connectAttr "polyTweak7.out" "polyExtrudeFace5.ip";
connectAttr "L_leg_Shape2.wm" "polyExtrudeFace5.mp";
connectAttr "polyExtrudeFace4.out" "polyTweak7.ip";
connectAttr "|Raptor|Hip|L_hip_1|L_leg_1|polySurfaceShape3.o" "polyExtrudeFace6.ip"
		;
...
connectAttr "R_kneeShape.wm" "polySphProj15.mp";
...
connectAttr "L_gun_Shape1.wm" "polySoftEdge7.mp";
